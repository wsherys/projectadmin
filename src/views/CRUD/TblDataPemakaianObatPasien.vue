<template>
  <div class="app-container">
      <h1>Data Pemakaian Obat Pasien</h1>
    <!-- filter -->
    <div class="filter-container">
        ...
        <el-dialog 
        title="Data Pemakaian Obat Pasien" 
                ...
                <el-form :model="post" :label-position="labelPosition" >
                    <el-row>
                      <el-col :span="12" class="app-container">
                        ...
                        prop="no_rm"
                        :rules="[
                            { required: true, message: 'Masukkan no rekam medis', trigger: 'blur' },
                        ]"
                        >
                            <el-input v-model="post.nama" placeholder="masukkan no rekam medis" autocomplete="off"></el-input>
                        </el-form-item>
                        ...
                        prop="umur"
                        >
                            <el-input v-model="post.nama" placeholder="masukkan umur" autocomplete="off"></el-input>
                        </el-form-item>
                        ...
                        prop="dokter"
                        >
                            <el-input v-model="post.nama" placeholder="masukkan dokter" autocomplete="off"></el-input>
                        </el-form-item>

                        <el-form-item label="Tanggal Pg(pagi)" :label-width="formLabelWidth" >
                        ...
                        <el-form-item label="Tanggal" :label-width="formLabelWidth">
    ...
    >
      ...
      <el-table-column label="No.Rekam Medis" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" >{{ row.no_rm }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="Umur" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" >{{ row.umur }}</span>
        </template>
      </el-table-column>

      <el-table-column label="Dokter" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" >{{ row.dokter }}</span>
        </template>
      </el-table-column>

      <el-table-column label="Ruangan" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" >{{ row.ruangan }}</span>
        </template>
      </el-table-column>

      <el-table-column label="Pagi" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" >{{ row.tglpagi }}</span>
        </template>
      </el-table-column>

      <el-table-column label="Sore" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" >{{ row.tglsore }}</span>
        </template>
      </el-table-column>
      

      <el-table-column label="Malam" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" >{{ row.tglmalam }}</span>
        </template>
      </el-table-column>

      <el-table-column label="Antibiotika" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" >{{ row.antibiotika }}</span>
        </template>
      </el-table-column>

      <el-table-column label="Obat-Obatan" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" >{{ row.obat }}</span>
        </template>
      </el-table-column>

      <el-table-column label="Obat-Obatan Suntik" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" >{{ row.obatsuntik }}</span>
        </template>
      </el-table-column>

      <el-table-column label="Peralatan Medik" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" >{{ row.peralatan_medik }}</span>
        </template>
      </el-table-column>

      <el-table-column label="Keterangan" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" >{{ row.keterangan }}</span>
        </template>
      </el-table-column>

      <el-table-column label="Nama Suster Jaga" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" >{{ row.suster_jaga }}</span>
        </template>
      </el-table-column>
