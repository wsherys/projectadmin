<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-input placeholder="Filter by Name" icon="search" v-model="filter" style="width: 200px;" >
      ...
      <el-button v-waves class="filter-item" type="primary" icon="el-icon-search" @click="filteraja">
        Search
      </el-button>
